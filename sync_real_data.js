...
// No external .env loader is required; this script can parse a local .env file automatically.
...
// Attempt to import 'pg' (node-postgres) for DB operations.
let pg;
try {
  pg = require("pg");
} catch (err) {
  console.error("Missing dependency 'pg'. Install it with: npm install pg");
  process.exit(1);
}
